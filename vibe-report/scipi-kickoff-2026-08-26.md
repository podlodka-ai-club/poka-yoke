...
- GitHub Actions run `33112581651` успешно выполнил curl-install и повторное update на `ubuntu-latest`, `macos-latest` и `windows-latest`; publish job на PR ожидаемо пропущен.
